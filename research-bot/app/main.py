...
from utils.file_parser import parse_text_file, parse_markdown_file, parse_pdf_file, parse_csv_file, get_files_in_directory
        ...
        if "parsed_content" in st.session_state:
            for file, content in st.session_state["parsed_content"].items():
                if content != "Unsupported file type.":
                    ...
                    summary = "Dummy summary"  # Placeholder for future implementation
